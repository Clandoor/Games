...
class Snake:
    ...
    def reset_snake(self):
        """
        This function makes the snake segments 'disappear' by relocating each of them in different position.
        It then clears the snake_segments list and then creates a new snake.
        :return: None
        """
        ...
        # This will clear the elements in the snake_segments list and remove all.
        self.snake_segments.clear()

        # Creating the snake once again.
        self.create_snake()
        self.snake_head = self.snake_segments[0]
